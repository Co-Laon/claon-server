...
public class BlockUserServiceTest {
    ...
    void successBlockUser() {
        try (MockedStatic<BlockUser> mockedBlock = mockStatic(BlockUser.class)) {
            ...
            // then
            org.assertj.core.api.Assertions.assertThat(this.blockUserRepository.findByUserIdAndBlockId(this.publicUser.getId(), this.blockUser.getId())).isNotNull();
        }
    }
    ...
    void successUnblockUser() {
        ...
        // then
        org.assertj.core.api.Assertions.assertThat(this.blockUserRepository.findAll()).isEmpty();
    }
