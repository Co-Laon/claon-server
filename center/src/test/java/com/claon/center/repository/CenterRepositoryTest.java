...
public class CenterRepositoryTest {
    ...
    void setUp() {
        ...
        reviewRepository.save(CenterReview.of(5, "test", USER_ID, center));

        sectorInfoRepository.save(SectorInfo.of(
                "testSectorInfo",
    ...
    public void successSearchCenterName() {
        ...
        // when
        var centerList = centerRepository.searchCenter(keyword);
    ...
    public void successSearchCenter() {
        ...
        // when
        var centerPage = centerRepositorySupport.searchCenter(name, PageRequest.of(0, 2));
    ...
    public void successDeleteCenter() {
        ...
        // when
        var resultCenter = centerRepository.findById(center.getId());
        var resultCenterBookmark = centerBookmarkRepository.findByUserIdAndCenterId(USER_ID, center.getId());
